        ...
        <table>
          ...
          <tr>
            ...
            <td>
              ...
              помощью REST API. При постраничном разбиении URL зависит от номера
              страницы. После регистрации данные пользователя подгружатся на
              сервер POST запросом. Если пользователь покидает свой аккаунт -
              содержимое его корзины сохраняется на сервер PATCH запросом, а
              после возвращения пользователя корзина снова заполняется товарами.
            </td>
          </tr>
          <tr>
            <td> Модель данных </td>
            <td>
              ...
              хранение в Store Redux. Store разбит на разделы, для более удобной
              работы.
            </td>
          </tr>
          <tr>
